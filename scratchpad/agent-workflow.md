...
|----------|---------|--------|
| `AGENTS.md` | Tells the agent what it has and how to use it | Not generated |
...
├── AGENTS.md              # Agent instructions: tools, workflows, escalation
...
### AGENTS.md — what the agent needs to know

The AGENTS.md tells the agent what it has and how to use it. Not API docs — workflows, in escalation order. This is generated by pyrung's project_emitter, tailored to the specific program; CLAUDE.md imports it for Claude Code.
...
5. Agent reads AGENTS.md (directly or through the CLAUDE.md import), discovers available tools, ready to go

The engineer doesn't configure anything beyond clicking Start. ClickNick sets up the workspace and the simulation. The agent discovers what's available from AGENTS.md.
...
**1. AGENTS.md** — generated from a template, populated with:
...
- Embedded in AGENTS.md instead of a separate file (fewer files for the agent to discover)
