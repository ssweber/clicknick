...
You can also force inputs to set up a condition, advance scan by scan, inspect tags or fill a Data View, and load a saved set of tag values so the model starts where the machine is.
